    ...
    <main className="flex-1 px-4 py-8 sm:px-6 sm:py-10 lg:px-16">
      <div className="mx-auto max-w-6xl">
        ...
        <div className="flex flex-col gap-10 lg:flex-row lg:gap-12">
          {/* Central content — left on desktop, below TOC on mobile */}
              ...
              <div className="mb-3 flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-sm text-foreground-muted">
                    CSIS SmartAssist: Developer &amp; Setup Guide
                  </p>
                </div>
              </div>
...
└───────────────────────────────────────┘`}
              ...
              <DocSection id="setup" icon={Server} title="Setup">
                ...
                <CodeBlock>{`git clone https://github.com/CSIS-SmartAssist/SmartAssist.git
cd SmartAssist
npm install`}</CodeBlock>
                ...
                <p>
                  ...
                  or symlink it so Next.js can load variables.
                </p>
                ...
                <p>
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-primary underline underline-offset-2 dark:text-accent-teal"
                  >
                    app.arcjet.com
                  </a>
...
npm run db:studio`}</CodeBlock>
              ...
              >
                <p>
                  ...
                  at repo root for the full list. Summary:
                </p>
                <ul className="list-inside list-disc space-y-1">
                  <li>
                  ...
                  <li>
                    <strong className="text-foreground">NEXTAUTH_URL</strong>,{" "}
                    <strong className="text-foreground">NEXTAUTH_SECRET</strong>
                    ,{" "}
                    <strong className="text-foreground">
                      GOOGLE_CLIENT_ID
                    </strong>
              ...
              <DocSection id="security" icon={Shield} title="Security">
                <ul className="list-inside list-disc space-y-1">
                  ...
                  <li>
                    ...
                    , Arcjet applies rate limiting and bot detection to API
                    routes.
                  </li>
                  <li>
                    Secrets stay in{" "}
              ...
              >
                <ul className="space-y-2">
                  ...
                  <li>
                    <a
                      href="https://github.com/CSIS-SmartAssist/SmartAssist"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center gap-1.5 text-primary hover:underline dark:text-accent-teal"
                    >
          ...
          {/* Sidebar TOC — right on desktop, above content on mobile */}
