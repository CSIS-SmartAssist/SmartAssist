  ...
  return (
    ...
    >
        ...
        <nav className="flex-1 overflow-y-auto p-4 space-y-1">
          <div className={`px-4 py-3 text-xs font-bold uppercase tracking-wider ${theme.secondaryText}`}>
            Main Menu
          </div>
          ...
          {/* My Courses */}
          <div className={`px-4 py-3 text-xs font-bold uppercase tracking-wider ${theme.secondaryText} mt-6`}>
            My Courses
          </div>
            ...
            {courses.map((course) => (
              <div
                ...
                className={`flex items-center gap-3 px-4 py-2 rounded-lg cursor-pointer transition-all duration-200 ${
                  course.active ? `${theme.accentBg} ${theme.text}` : theme.secondaryText
                }`}
              >
                <div
        ...
        {/* Footer Actions */}
        <div className={`p-4 space-y-3 border-t border-opacity-10 border-current`}>
          <button
          ...
          <div className={`flex justify-around text-sm ${theme.secondaryText}`}>
            ...
            <button className="hover:opacity-80 transition-opacity" aria-label="Logout">
              🚪
            </button>
          </div>
        </div>
